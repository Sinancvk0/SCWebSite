...
namespace SC.DataLayer.Migrations
{
    ...
    [Migration("20230914024018_Tags_Mig3")]
    partial class Tags_Mig3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlogDetaillsTag", b =>
                {
                    ...
                    b.HasKey("BlogDetaillsId", "TagId");

                    b.HasIndex("TagId");

                    b.ToTable("BlogDetaillsTag");
                });
            ...
            modelBuilder.Entity("BlogDetaillsTag", b =>
                {
                    b.HasOne("SC.Models.BlogDetaills", null)
                        .WithMany()
                        .HasForeignKey("BlogDetaillsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SC.Models.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
